...
public final class DateTimeUtils {
     ...
     * @author liandeliang
     * @param bigDateMilliseconds
     * @param smallDateMilliseconds
     * @param diffMilliseconds
     * @return
     */
    public static boolean isBigThenTimestamp(Long bigDateMilliseconds,Long smallDateMilliseconds,long diffMilliseconds){
        return bigDateMilliseconds - smallDateMilliseconds >= diffMilliseconds;
    }
