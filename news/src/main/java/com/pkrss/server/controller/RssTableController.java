...
import com.pkrss.server.domain.RssTable;
...
@Controller
@RequestMapping("/rsstables")
public final class RssTableController extends BaseReadonlyRecordController<RssTable> {
    ...
    @ResponseBody
    public BasePageResponse<RssTable> getRecords(HttpServletRequest request, HttpServletResponse response) {
    ...
    @ResponseBody
    public BaseResponse<RssTable> getRecordByID(HttpServletRequest request, @PathVariable Integer id) {
    ...
    @ResponseBody
    public BaseResponse<RssTable> addRecord(HttpServletRequest request, @RequestBody RssTable record){
    ...
    @ResponseBody
    public BaseResponse<RssTable> updateRecord(HttpServletRequest request, @RequestBody RssTable record, @PathVariable Integer id) {
        record.setId(id);
